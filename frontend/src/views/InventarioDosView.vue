<template>
  <div class="card shadow-sm">
    <div class="card-body">
      ...
      <div class="inventory-list vstack gap-3" ref="scrollContainer" @scroll="handleScroll">
        <div
        ...
        <div v-if="isLoadingMore" class="text-center my-2">
...
const buyIngredient = async (item) => {
  try {
    ...
    toast.success(`✅ Compraste ${quantityBought} ${item.unit} de ${item.name}`)
  } catch (error) {
